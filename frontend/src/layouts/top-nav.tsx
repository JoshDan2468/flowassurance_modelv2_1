  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-border/60 bg-background/70 px-3 backdrop-blur-xl sm:px-5">
      ...
      <div className="hidden flex-col leading-tight md:flex">
        <span className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground">Project</span>
        <span className="text-sm font-medium text-foreground">North Sea · Field Bravo-7</span>
      </div>
      <div className="ml-auto flex items-center gap-2 sm:gap-3">
        <Badge variant="outline" className="hidden border-[color:var(--risk-low)]/40 bg-[color:var(--risk-low)]/10 text-[color:var(--risk-low)] sm:inline-flex">
