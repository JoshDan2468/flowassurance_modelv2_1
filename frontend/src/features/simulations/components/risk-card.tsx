...
import { riskBgClass, riskTextClass } from "@/features/simulations/lib/risk";
import type { RiskItem } from "@/features/simulations/types/prediction";
    ...
    >
      <Card className={`border ${riskBgClass(risk.level)}`}>
        <CardContent className="p-4">
          ...
          <Progress value={risk.probability * 100} className="mt-3 h-1.5 bg-background/50" />
        </CardContent>
      </Card>
    </motion.div>
  );
