  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-border/60 bg-background/70 px-3 backdrop-blur-xl sm:px-5">
      ...
      <div className="ml-auto flex items-center gap-2 sm:gap-3">
        <Badge
          variant="outline"
          className="hidden border-(--risk-low)/40 bg-(--risk-low)/10 text-risk-low sm:inline-flex"
        >
          <span className="mr-1.5 inline-block h-1.5 w-1.5 animate-pulse rounded-full bg-risk-low" />
          Live Telemetry
        </Badge>
        <Button
          variant="ghost"
        ...
        >
          ...
          <span className="absolute right-2 top-2 h-1.5 w-1.5 rounded-full bg-risk-high" />
        </Button>
        {/* <button className="flex items-center gap-2 rounded-md border border-border/60 bg-card/60 px-2 py-1.5 text-left transition hover:bg-card">
          ...
          <div className="hidden flex-col leading-tight sm:flex">
            <span className="text-xs font-medium text-foreground">Eng. Taiwo Lawal</span>
