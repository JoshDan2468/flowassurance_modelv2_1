...
export const Route = createFileRoute("/assets")({
  head: () => ({
    meta: [
      { title: "Assets — FAIP" },
      { name: "description", content: "Subsea pipeline asset registry." },
    ],
  }),
  ...
  return (
    <div className="mx-auto flex max-w-350 flex-col gap-6">
      <div>
        ...
        <h1 className="mt-1 text-2xl font-semibold tracking-tight sm:text-3xl">Subsea Assets</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Pipeline inventory under FAIP monitoring.
        </p>
      </div>
            ...
            <CardContent>
              <dl className="grid grid-cols-2 gap-2 text-xs">
                <Stat
                  ...
                  label="Length"
                  value={`${a.length_km.toFixed(1)} km`}
                />
                <Stat
